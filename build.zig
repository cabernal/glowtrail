...
pub fn build(b: *std.Build) void {
    ...
    const native_module = createGameModule(b, target, optimize, native_sokol_mod, null);
    ...
    if (emsdk_root_opt) |emsdk_root| {
        ...
        const web_module = createGameModule(b, web_target, optimize, web_sokol_mod, emsdk_root);
...
fn buildLibSokol(
    ...
    var cflags_buf: [8][]const u8 = undefined;
